...
const ProductListView = ({ image }) => {
    const context = useContext(ProductContext);
  return (
    <div className="productCard rounded-md border border-[#d8d8d8] overflow-hidden shadow-md flex items-center">
      <div className="imgWrapper w-[25%] group overflow-hidden rounded-t-md relative transition-all ">
        <Link>
          <div className="image w-full overflow-hidden max-h-[220px]">
      ...
      <div className="product-info px-8 w-[75%] py-5">
        ...
        <p className="text-[14px] mb-3">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi.</p>
