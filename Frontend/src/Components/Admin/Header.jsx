...
const Header = ({setShow,show}) => {
  ...
  return (
    <header className={`w-full z-50 fixed transition-all pr-7 h-[auto] py-2 ${show? "pl-70" : "pl-5"} bg-[#fff] shadow-md flex items-center justify-between`}>
      <div className="part1">
        <Button onClick={() => setShow(!show)} className="!w-[40px] !h-[40px] !min-w-[40px] !rounded-full !text-[rgba(0,0,0,0.8)]">
          ...
          <MenuItem onClick={handleClose} className="!bg-white">
            <div className="flex items-center gap-3">
              ...
              <div className="info">
                ...
                <p className="text-[12px] font-[400] opacity-70 !m-0">admin@gmail.com</p>
              </div>
            </div>
          </MenuItem>
          <Divider />
